...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { celular: @contato.celular, ddr: @contato.ddr, descrisao: @contato.descrisao, ramal: @contato.ramal, skype: @contato.skype } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { celular: @contato.celular, ddr: @contato.ddr, descrisao: @contato.descrisao, ramal: @contato.ramal, skype: @contato.skype } }
